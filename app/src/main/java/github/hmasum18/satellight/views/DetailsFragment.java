...
import gov.nasa.worldwind.layer.LandsatLayer;
...
public class DetailsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //data
        if(!mapsActivity.activeSatCode.equals("moon"))
        satelliteData = mapsActivity.allSatelliteData.get(mapsActivity.activeSatCode);
